...
namespace Cen.Wms.Data.Migrations
{
    ...
    [Migration("20210209014701_TPacLineAdded")]
    partial class TPacLineAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cen.Wms.Data.Models.Purchase.PacLineRow", b =>
                {
                    ...
                    b.Property<string>("PacLineId")
                        .HasColumnType("text")
                        .HasColumnName("pac_line_id");

                    b.Property<Guid?>("PacRowId")
                        .HasColumnType("uuid")
                        .HasColumnName("pac_row_id");
                    ...
                    b.HasIndex("PacRowId")
                        .HasDatabaseName("i_x_pac_line_pac_row_id");

                    b.ToTable("pac_line");
                });

            modelBuilder.Entity("Cen.Wms.Data.Models.Purchase.PacRow", b =>
                {
                    b.Property<Guid?>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Cen.Wms.Data.Models.Purchase.PacLineRow", b =>
                {
                    b.HasOne("Cen.Wms.Data.Models.Purchase.PacRow", null)
                        .WithMany("Lines")
                        .HasForeignKey("PacRowId")
                        .HasConstraintName("f_k_pac_line__pac_pac_row_id");
                });
