...
namespace Cen.Wms.Data.Migrations
{
    ...
    [Migration("20210327191850_TPurchaseTaskHeadFIsExported")]
    partial class TPurchaseTaskHeadFIsExported
    {
            ...
            modelBuilder.Entity("Cen.Wms.Data.Models.Purchase.PacLineStateRow", b =>
                {
                    b.HasOne("Cen.Wms.Data.Models.Purchase.PacLineRow", "PacLine")
                        .WithMany("PacLineStates")
                        .HasForeignKey("PacLineId")
