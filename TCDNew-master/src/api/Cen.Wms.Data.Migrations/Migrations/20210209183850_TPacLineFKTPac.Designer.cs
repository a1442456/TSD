...
namespace Cen.Wms.Data.Migrations
{
    ...
    [Migration("20210209183850_TPacLineFKTPac")]
    partial class TPacLineFKTPac
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cen.Wms.Data.Models.Purchase.PacLineRow", b =>
                {
                    ...
                    b.HasIndex("PacId")
                        .HasDatabaseName("i_x_pac_line_pac_id");
            ...
            modelBuilder.Entity("Cen.Wms.Data.Models.Purchase.PacLineRow", b =>
                {
                    b.HasOne("Cen.Wms.Data.Models.Purchase.PacRow", "Pac")
                        .WithMany("Lines")
                        .HasForeignKey("PacId")
                        .HasConstraintName("f_k_pac_line__pac_pac_id")
