...
{
    public class FacilityAccessWithdrawProcessor: IQueryProcessor<FacilityAccessEditReq, RpcResponse<bool>>
    {
        ...
        public FacilityAccessWithdrawProcessor(
        ...
        public async Task<RpcResponse<bool>> Run(IUserIdProvider userIdProvider, FacilityAccessEditReq request)
        {
            ...
            var facilityAccessWithdrawResult = 
                await _facilityAccessRepository.FacilityAccessWithdraw(request.FacilityId, request.UserId);
            
            await _unitOfWork.Context.SaveChangesAsync();
            _unitOfWork.Commit();
            
            return facilityAccessWithdrawResult;
        }
    }
}